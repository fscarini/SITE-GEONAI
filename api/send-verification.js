...
export default async function handler(req, res) {
    ...
    try {
        ...
        // 2. Salva o código no Vercel KV com expiração de 5 minutos (300 segundos)
        // A chave será o e-mail do usuário
        await kv.set(email, code, { ex: 300 });

        // 3. Envia o e-mail para o usuário com o código
        await resend.emails.send({
            from: 'noreply@geonai.com.br', // Crie este e-mail no Resend (em "Domains")
            to: email,
